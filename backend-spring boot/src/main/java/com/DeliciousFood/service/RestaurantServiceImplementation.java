...
import com.DeliciousFood.request.CreateRestaurantRequest;
...
public class RestaurantServiceImplementation implements RestaurantService {
	...
	public Restaurant createRestaurant(CreateRestaurantRequest req,User user) {
		...
		address.setCity(((Address) req.getAddress()).getCity());
		address.setCountry(((Address) req.getAddress()).getCountry());
		address.setFullName(((Address) req.getAddress()).getFullName());
		address.setPostalCode(((Address) req.getAddress()).getPostalCode());
		address.setState(((Address) req.getAddress()).getState());
		address.setStreetAddress(((Address) req.getAddress()).getStreetAddress());
